...
import userRoutes from './routes/users-new';
import databaseRoutes from './routes/database-new';
import { initializeDatabase, closeDatabase } from './infrastructure/config/database';
